        ...
        <div className="mt-14 grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
          {images.map((src, i) => (
            <motion.button
              ...
              className={`group relative overflow-hidden border border-gold/20 bg-cream ${
                i % 3 === 0 ? "aspect-[3/4] md:col-span-2 md:row-span-2" : "aspect-square"
              }`}
      ...
      <AnimatePresence>
        {activeIndex !== null && (
          ...
          >
            ...
            >
              <div
                className="aspect-[4/5] w-[80vw] max-w-2xl bg-cover bg-center sm:aspect-[3/4]"
                style={{
